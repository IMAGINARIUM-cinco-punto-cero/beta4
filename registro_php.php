...
$sql = "INSERT INTO proyectos (
    nombre_proyecto, total_estudiantes, mujeres_estudiantes, hombres_estudiantes, otro_genero_estudiantes, nombres_estudiantes,
    total_profesores, mujeres_profesores, hombres_profesores, otro_genero_profesores, nombres_profesores,
    objetivo_proyecto, responsabilidad_social, equidad_social_genero, inclusion, excelencia, innovacion_social,
    vanguardia, interculturalidad, sector_beneficiado, nombre_empresa_institucion, origen_desarrollo_proyecto,
    asignaturas_pe, fecha_inicio_proyecto, estado_proyecto, url_evidencia_proyecto, producto_generado, fecha_fin_proyecto
) VALUES (
    '$nombre_proyecto', '$total_estudiantes', '$mujeres_estudiantes', '$hombres_estudiantes', '$otro_genero_estudiantes', '$nombres_estudiantes',
    '$total_profesores', '$mujeres_profesores', '$hombres_profesores', '$otro_genero_profesores', '$nombres_profesores',
    '$objetivo_proyecto', '$responsabilidad_social', '$equidad_social_genero', '$inclusion', '$excelencia', '$innovacion_social',
...
if ($conexion->query($sql) === TRUE) {
    ...
    echo "✅ Proyecto registrado exitosamente. ID generado: " . $id;
} else {
